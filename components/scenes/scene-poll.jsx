/* eslint-disable */
// ─────────────────────────────────────────────
// Poll Scene — Live audience poll with animated bars
// Use case: instant audience vote, e.g. "Rust ou Go?"
// ─────────────────────────────────────────────
(() => {
  const { useState, useEffect, useRef } = React;

  function PollScene({ tweaks }) {
    const {
      primary, accent,
      pollQuestion = 'O que você usaria pra começar um projeto novo em 2026?',
      pollOptions, // optional override; if not set, uses default
      pollTotalVotes = 1847,
      ...
      <div style={{ position: 'absolute', inset: 0, overflow: 'hidden' }}>
        ...
        <div style={{
          ...
          <span style={{
            ...
            Aberta · {tweaks.pollTimeLeft || '01:24'} restantes
          </span>
        </div>
  ...
  Object.assign(window, { PollScene });
})();
